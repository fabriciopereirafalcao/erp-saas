...
export const Sidebar = memo(function Sidebar({ currentView, onNavigate, isOpen, onClose }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { id: "chartOfAccountsHierarchical" as NavigationView, label: "Plano de Contas", icon: FileText },
    { id: "dregerencial" as NavigationView, label: "DRE Gerencial", icon: BarChart3 },

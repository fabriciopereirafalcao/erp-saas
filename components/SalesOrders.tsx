...
export function SalesOrders({ onNavigateToNFe }: SalesOrdersProps = {}) {
  ...
  const getInstallmentsInfo = (orderId: string) => {
    ...
    const orderTransactions = getActiveTransactions(safeFinancialTransactions).filter(
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-semibold text-gray-900 mb-2">Pedidos de Venda</h1>
